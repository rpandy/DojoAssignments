...
-- What query would you run to get total # of sites created per month per year for the client with an id of 1? 
...
-- What query would you run to get the total # of leads generated for each of the sites between January 1, 
...
-- What query would you run to get a list of client names and the total # of leads we've generated for each of our clients between January 1, 
...
-- What query would you run to get a list of client names and 
