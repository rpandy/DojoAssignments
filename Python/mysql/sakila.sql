...
SELECT film.description, film.rating, film.special_features, actor.first_name, actor.last_name
FROM film 
JOIN film_category
ON film.film_id = film_category.film_id
JOIN category
